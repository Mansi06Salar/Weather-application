...
SECRET_KEY = 'django-insecure-j^qc)@%e!0pgnw3^z0$@_q#q2fc868_%9k#vy@bf(q#wqp2+mv'
...
def homepage(request):
   #return HttpResponse("<h2>This is my homepage</h2>")
...
<html lang="en">
  ...
  <body>
    <center>
        ...
        <form action = "weather">
            <input type = "text" name = "c" placeholder = "Enter City Name"/>
            <input type = "submit"/>
